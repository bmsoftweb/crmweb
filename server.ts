...
import { pool, checkDbHealth } from './server/db';
import { createCrudRouter } from './server/crud';
import { createCrmRouter } from './server/crm';
import { createImportBmRouter } from './server/importbm';
import { createConfigRouter } from './server/config';
import { createImportArquivoRouter } from './server/importarquivo';
import { createEnderecosRouter } from './server/enderecos';
import { createParticipantesRouter } from './server/participantes';
import { createCampanhasRouter } from './server/campanhas';
import { iniciarEnvioWhatsApp } from './server/whatsapp';
import { createContratosRouter, createWebhookD4SignRouter, iniciarRotinaContratos } from './server/contratos';
